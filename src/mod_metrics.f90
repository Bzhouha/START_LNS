...
! ----------------------------------------------------------------
    ...
    subroutine compute_convariant_metrics_2d()
        ...
        call DMDAVecGetArray(DA, XIX, tmp, ierr)
        tmp(:,:,:)=xi_x(:,:,:)
        call DMDAVecRestoreArray(DA, XIX, tmp, ierr)
        call DMGlobalToLocalBegin(DA, XIX, INSERT_VALUES, XIX_local, ierr)

        call DMDAVecGetArray(DA, XIY, tmp, ierr)
        tmp(:,:,:)=xi_y(:,:,:)
        call DMDAVecRestoreArray(DA, XIY, tmp, ierr)
        call DMGlobalToLocalEnd(DA, XIX, INSERT_VALUES, XIX_local, ierr)
        call DMGlobalToLocalBegin(DA, XIY, INSERT_VALUES, XIY_local, ierr)

        call DMDAVecGetArray(DA, ETAX, tmp, ierr)
        tmp(:,:,:)=eta_x(:,:,:)
        call DMDAVecRestoreArray(DA, ETAX, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAY, tmp, ierr)
        tmp(:,:,:)=eta_y(:,:,:)
        call DMDAVecRestoreArray(DA, ETAY, tmp, ierr)
        ...
        call DMDAVecGetArrayRead(DA, XIX_local, tmp, ierr)
        xi_x_local=tmp
        call DMDAVecRestoreArrayRead(DA, XIX_local, tmp, ierr)

        call DMDAVecGetArrayRead(DA, XIY_local, tmp, ierr)
        xi_y_local=tmp
        call DMDAVecRestoreArrayRead(DA, XIY_local, tmp, ierr)

        call DMDAVecGetArrayRead(DA, ETAX_local, tmp, ierr)
        eta_x_local=tmp
        call DMDAVecRestoreArrayRead(DA, ETAX_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, ETAY_local, tmp, ierr)
        eta_y_local=tmp
        call DMDAVecRestoreArrayRead(DA, ETAY_local, tmp, ierr)
    ...
    subroutine compute_convariant_metrics_3d()
        ...
        call DMDAVecGetArray(DA, XIZ, tmp, ierr)
        tmp(:,:,:) = xi_z(:,:,:)
        call DMDAVecRestoreArray(DA, XIZ, tmp, ierr)
        call DMGlobalToLocalEnd(DA, XIY, INSERT_VALUES, XIY_local, ierr)
        ...
        call DMDAVecGetArray(DA, ETAZ, tmp, ierr)
        tmp(:,:,:) = eta_z(:,:,:)
        call DMDAVecRestoreArray(DA, ETAZ, tmp, ierr)
        call DMGlobalToLocalEnd(DA, ETAY, INSERT_VALUES, ETAY_local, ierr)
        call DMGlobalToLocalBegin(DA, ETAZ, INSERT_VALUES, ETAZ_local, ierr)

        call DMDAVecGetArray(DA, PHIX, tmp, ierr)
        tmp(:,:,:) = phi_x(:,:,:)
        call DMDAVecRestoreArray(DA, PHIX, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIY, tmp, ierr)
        tmp(:,:,:) = phi_y(:,:,:)
        call DMDAVecRestoreArray(DA, PHIY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIZ, tmp, ierr)
        tmp(:,:,:) = phi_z(:,:,:)
        call DMDAVecRestoreArray(DA, PHIZ, tmp, ierr)
        ...
        xi_y_local=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, XIZ_local, tmp, ierr)
        xi_z_local=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIZ_local, tmp, ierr)
        ...
        call DMDAVecRestoreArrayRead(DA, ETAY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, ETAZ_local, tmp, ierr)
        eta_z_local=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAZ_local, tmp, ierr)

        call DMDAVecGetArrayRead(DA, PHIX_local, tmp, ierr)
        phi_x_local=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIX_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, PHIY_local, tmp, ierr)
        phi_y_local=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, PHIZ_local, tmp, ierr)
        phi_z_local=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIZ_local, tmp, ierr)
    ...
    subroutine delivery_by_dmda()
        ...
        call DMDAVecGetArray(DA, XIXX, tmp, ierr)
        tmp(:,:,:)=xi_xx(:,:,:)
        call DMDAVecRestoreArray(DA, XIXX, tmp, ierr)
        call DMGlobalToLocalBegin(DA, XIXX, INSERT_VALUES, XIXX_local, ierr)

        call DMDAVecGetArray(DA, XIYY, tmp, ierr)
        tmp(:,:,:)=xi_yy(:,:,:)
        call DMDAVecRestoreArray(DA, XIYY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, XIZZ, tmp, ierr)
        tmp(:,:,:)=xi_zz(:,:,:)
        call DMDAVecRestoreArray(DA, XIZZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, XIXY, tmp, ierr)
        tmp(:,:,:)=xi_xy(:,:,:)
        call DMDAVecRestoreArray(DA, XIXY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, XIXZ, tmp, ierr)
        tmp(:,:,:)=xi_xz(:,:,:)
        call DMDAVecRestoreArray(DA, XIXZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, XIYZ, tmp, ierr)
        tmp(:,:,:)=xi_yz(:,:,:)
        call DMDAVecRestoreArray(DA, XIYZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAXX, tmp, ierr)
        tmp(:,:,:)=eta_xx(:,:,:)
        call DMDAVecRestoreArray(DA, ETAXX, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAYY, tmp, ierr)
        tmp(:,:,:)=eta_yy(:,:,:)
        call DMDAVecRestoreArray(DA, ETAYY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAZZ, tmp, ierr)
        tmp(:,:,:)=eta_zz(:,:,:)
        call DMDAVecRestoreArray(DA, ETAZZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAXY, tmp, ierr)
        tmp(:,:,:)=eta_xy(:,:,:)
        call DMDAVecRestoreArray(DA, ETAXY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAXZ, tmp, ierr)
        tmp(:,:,:)=eta_xz(:,:,:)
        call DMDAVecRestoreArray(DA, ETAXZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, ETAYZ, tmp, ierr)
        tmp(:,:,:)=eta_yz(:,:,:)
        call DMDAVecRestoreArray(DA, ETAYZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIXX, tmp, ierr)
        tmp(:,:,:)=phi_xx(:,:,:)
        call DMDAVecRestoreArray(DA, PHIXX, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIYY, tmp, ierr)
        tmp(:,:,:)=phi_yy(:,:,:)
        call DMDAVecRestoreArray(DA, PHIYY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIZZ, tmp, ierr)
        tmp(:,:,:)=phi_zz(:,:,:)
        call DMDAVecRestoreArray(DA, PHIZZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIXY, tmp, ierr)
        tmp(:,:,:)=phi_xy(:,:,:)
        call DMDAVecRestoreArray(DA, PHIXY, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIXZ, tmp, ierr)
        tmp(:,:,:)=phi_xz(:,:,:)
        call DMDAVecRestoreArray(DA, PHIXZ, tmp, ierr)
        ...
        call DMDAVecGetArray(DA, PHIYZ, tmp, ierr)
        tmp(:,:,:)=phi_yz(:,:,:)
        call DMDAVecRestoreArray(DA, PHIYZ, tmp, ierr)
        ...
        call DMDAVecGetArrayRead(DA, XIXX_local, tmp, ierr)
        xi_xx=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIXX_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, XIYY_local, tmp, ierr)
        xi_yy=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIYY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, XIZZ_local, tmp, ierr)
        xi_zz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIZZ_local, tmp, ierr)

        call DMDAVecGetArrayRead(DA, XIXY_local, tmp, ierr)
        xi_xy=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIXY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, XIXZ_local, tmp, ierr)
        xi_xz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIXZ_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, XIYZ_local, tmp, ierr)
        xi_yz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, XIYZ_local, tmp, ierr)
        ...
        call DMDAVecGetArrayRead(DA, ETAXX_local, tmp, ierr)
        eta_xx=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAXX_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, ETAYY_local, tmp, ierr)
        eta_yy=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAYY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, ETAZZ_local, tmp, ierr)
        eta_zz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAZZ_local, tmp, ierr)

        call DMDAVecGetArrayRead(DA, ETAXY_local, tmp, ierr)
        eta_xy=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAXY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, ETAXZ_local, tmp, ierr)
        eta_xz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAXZ_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, ETAYZ_local, tmp, ierr)
        eta_yz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, ETAYZ_local, tmp, ierr)
        ...
        call DMDAVecGetArrayRead(DA, PHIXX_local, tmp, ierr)
        phi_xx=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIXX_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, PHIYY_local, tmp, ierr)
        phi_yy=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIYY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, PHIZZ_local, tmp, ierr)
        phi_zz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIZZ_local, tmp, ierr)

        call DMDAVecGetArrayRead(DA, PHIXY_local, tmp, ierr)
        phi_xy=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIXY_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, PHIXZ_local, tmp, ierr)
        phi_xz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIXZ_local, tmp, ierr)
        call DMDAVecGetArrayRead(DA, PHIYZ_local, tmp, ierr)
        phi_yz=real(tmp)
        call DMDAVecRestoreArrayRead(DA, PHIYZ_local, tmp, ierr)
