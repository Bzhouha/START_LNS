...
3. ```cd START_LNS```
4. Run the make command to build the software:```make```
5. Run the make install command to install the software:```make install```
6. This will install the software to the ~/bin directory. You can then run the software by typing the following command in a terminal:```START+LNS -f config.ini```
